...
export const BOARD_FOR: Record<VisualForm, BoardKind> = {
  ...
  // Keep Manim narrow rather than disabled: measured geometry and mathematical motion fit its
  // vocabulary. Real-world labelled subjects remain with the sandbox so they cannot degrade into
