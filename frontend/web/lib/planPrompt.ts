...
- "title" is 3-7 words and names the exact insight in that step. Vary titles by teaching role: question/hook, mechanism, worked step, contrast, or synthesis. Never use "Introduction", "Overview", "Core idea", "How it works", "Idea 2", "Quick check", or a raw page/slide/figure locator. Do not repeat the main topic as a prefix on every title. "caption" is one precise sentence describing what that step explains. "reason" is a <=16-word first-person planning thought tied to the student's question.
...
Create at least 5 subtopics and continue for as many as the subject genuinely requires. There is no maximum subtopic count. "title" is 3-6 words and names the precise insight being taught. Vary titles by role: use a curiosity question for a hook, a causal/action title for a mechanism, a concrete worked-example title, a contrast title, and a synthesis title where appropriate. Never use "Introduction", "Overview", "Core idea", "How it works", "Idea 2", "Quick check", or a raw page/slide/figure locator. Do not prefix every title with the main topic, and never create duplicate titles or numbered suffixes. "caption" is ONE sentence, <=18 words, previewing what that part of the lesson will teach.
...
Keep every title precise and distinct in 3-6 words. Preserve strong existing titles, but replace generic labels, repeated topic prefixes, raw source locators, duplicates, and numbered suffixes with role-aware teaching titles.
