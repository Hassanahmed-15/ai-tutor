...
export const PLANNING_ANGLES = [
  { id: "standard", label: "Standard", instruction: "Use the clearest, most conventional teaching order for this topic — hook, mechanism, comparison, worked example." },
...
Keep only the subtopics the student's request needs, plus every subtopic the requested revision adds. Never add a recap, summary or conclusion subtopic, and drop one if the current outline has it.
