            ...
            return (
              <li key={page.pageNumber}>
                ...
                >
                  ...
                  {/* The chosen area, drawn back onto the thumbnail, so the grid shows which page
                      has been narrowed rather than that being visible only on the big preview. */}
                  {isSelected && regionFor?.(page.pageNumber) && (
                    <span
                      aria-hidden="true"
                      ...
                      style={{
                        ...
                        left: `${regionFor!(page.pageNumber)!.x * 100}%`,
                        top: `${regionFor!(page.pageNumber)!.y * 100}%`,
                        width: `${regionFor!(page.pageNumber)!.width * 100}%`,
                        height: `${regionFor!(page.pageNumber)!.height * 100}%`,
                      }}
                    />
                  )}
                </button>
